...
func (f *Figure) DrawFigure() OperationFunc {
	return func(t screen.Texture) {
		t.Fill(image.Rect(f.X - 100, f.Y + 50, f.X + 100, f.Y - 50), color.RGBA{255, 255, 0, 1}, screen.Src)
    	t.Fill(image.Rect(f.X - 50, f.Y - 100, f.X + 50, f.Y + 100), color.RGBA{255, 255, 0, 1}, screen.Src)
	}
}
